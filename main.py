...
# Endpoints obsoletos eliminados - usar /reports y /dashboard en su lugar

# @app.get("/dashboard-simple-emails", response_class=HTMLResponse)  # OBSOLETO - ELIMINADO
def dashboard_simple_emails_OBSOLETO(request: Request):
